...
export default function LandscapingHeader() {
    return (
        <header className="fixed top-0 left-0 w-full z-50 py-6 bg-white/95 backdrop-blur-sm border-b border-[#d8f3dc] shadow-sm">
