...
export default function PaintingCTA() {
    const t = useTranslations('PaintingPage.finalCTA');
    ...
    return (
        <section className="py-20 bg-gradient-to-br from-blue-900 via-indigo-800 to-indigo-900 relative overflow-hidden">
            {/* Background Pattern */}
