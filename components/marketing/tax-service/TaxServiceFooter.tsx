...
export default function TaxServiceFooter() {
        ...
        <footer className="bg-slate-900 text-slate-300 py-16 border-t border-slate-800">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
                            High-impact marketing solutions for professional tax offices and preparers. We help you capture new clients and maintain a steady flow of leads year-round.
                        </p>
                    </div>
                        ...
                        <ul className="space-y-6">
                            <li>
                                <a
                                    ...
                                    className="hover:text-blue-400 transition-colors flex items-start gap-4 group"
                                >
                                    <Mail className="w-5 h-5 text-slate-500 group-hover:text-blue-400 flex-shrink-0 mt-0.5" />
                            ...
                            <li>
                                <a
                                    ...
                                    className="hover:text-blue-400 transition-colors flex items-start gap-4 group"
                                >
                                    <Phone className="w-5 h-5 text-slate-500 group-hover:text-blue-400 flex-shrink-0 mt-0.5" />
                                    <div className="flex flex-col">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-400">
                            <li className="hover:text-blue-400 transition-colors cursor-pointer list-disc list-inside">EDDM (Direct Mail)</li>
                            <li className="hover:text-blue-400 transition-colors cursor-pointer list-disc list-inside">Door Hangers</li>
                            <li className="hover:text-blue-400 transition-colors cursor-pointer list-disc list-inside">Google Ads</li>
                            <li className="hover:text-blue-400 transition-colors cursor-pointer list-disc list-inside">Pinterest Marketing</li>
                            <li className="hover:text-blue-400 transition-colors cursor-pointer list-disc list-inside">Yard Signs</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-slate-500 font-medium tracking-wide">
                    <p>© {currentYear} Genes Marketing. Specialized Marketing for Tax Service Pros.</p>
