...
export default function TreeServiceHero() {
    const t = useTranslations('TreeServicePage.hero');
    ...
    const handleSecondaryCTA = () => {
        window.open('https://www.pinterest.com/genesmarketing/tree-service-marketing/', '_blank');
    };

    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-950 via-green-900 to-emerald-800 pt-20">
            {/* Background Pattern */}
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <TreeDeciduous className="absolute top-20 left-10 w-16 h-16 text-white/5 animate-pulse" style={{ animationDelay: '0s' }} />
                <TreeDeciduous className="absolute top-40 right-20 w-20 h-20 text-white/5 animate-pulse" style={{ animationDelay: '1s' }} />
                <TreeDeciduous className="absolute bottom-32 left-1/4 w-12 h-12 text-white/5 animate-pulse" style={{ animationDelay: '2s' }} />
                <TreeDeciduous className="absolute bottom-20 right-1/3 w-24 h-24 text-white/5 animate-pulse" style={{ animationDelay: '1.5s' }} />
            </div>
