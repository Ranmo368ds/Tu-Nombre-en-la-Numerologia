...
export default function ExpectedResults() {
    ...
    const results = [
        { icon: DoorOpen, key: 'doorHangers', color: 'purple' },
    ...
    return (
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
            <div className="max-w-6xl mx-auto px-6">
                ...
                {/* Combined Effect */}
                <div className="bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 rounded-2xl p-10 text-white shadow-2xl">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h3 className="text-3xl font-bold mb-4">{t('combined.title')}</h3>
