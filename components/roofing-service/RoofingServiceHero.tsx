...
export default function RoofingServiceHero() {
    const t = useTranslations('RoofingPage.hero');
    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 pt-20">
            {/* Background Pattern */}
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <Home className="absolute top-20 left-10 w-16 h-16 text-blue-400/20 animate-pulse" />
                <Home className="absolute bottom-32 right-20 w-20 h-20 text-blue-400/20 animate-pulse delay-1000" />
                <Home className="absolute top-1/3 right-1/4 w-12 h-12 text-blue-400/20 animate-pulse delay-500" />
            </div>

            <div className="container mx-auto px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 bg-blue-700/50 backdrop-blur-sm border border-blue-600/30 rounded-full px-6 py-2 mb-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                        <button
                            ...
                            className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
                        >
