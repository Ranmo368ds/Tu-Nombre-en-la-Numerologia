...
export default function BenefitsSection() {
    ...
    const BENEFITS = [
        {
            icon: Users,
            title: t('items.traffic.title'),
            description: t('items.traffic.desc'),
            color: "text-blue-500",
            bg: "bg-blue-500/10",
        },
        {
            icon: ShoppingCart,
            title: t('items.intent.title'),
            description: t('items.intent.desc'),
        ...
        {
            icon: Layout,
            title: t('items.creative.title'),
            description: t('items.creative.desc'),
        ...
        },
        {
            ...
            description: t('items.performance.desc'),
            color: "text-cyan-500",
            bg: "bg-cyan-500/10",
        },
    ];
