...
export default function LandscapingMarketingSystem() {
    const t = useTranslations('LandscapingPage.marketingSystem');
    ...
    const pillars = [
        ...
        },
        {
            id: 'doorHangers',
            icon: DoorOpen,
            gradient: 'from-[#d8f3dc] to-[#74c69d]',
            accent: '#2d6a4f',
            bgColor: 'bg-white',
            iconBg: 'bg-[#d8f3dc]',
            textColor: 'text-[#081c15]'
        },
        {
            id: 'pinterest',
            icon: Image,
            gradient: 'from-[#081c15] to-[#2d6a4f]',
            accent: '#52b788',
            bgColor: 'bg-[#081c15]',
            iconBg: 'bg-white/10',
    ...
    return (
        <section className="py-24 bg-[#d8f3dc]/20">
                        ...
                        >
                            ...
                            <div className={`lg:w-2/5 relative flex items-center justify-center p-16 bg-gradient-to-br ${gradient}`}>
                                ...
                                <div className="relative z-10 w-48 h-48 bg-white/10 backdrop-blur-md rounded-[2.5rem] border border-white/20 flex items-center justify-center shadow-inner group">
                                    ...
                                    <div className="absolute -bottom-4 -right-4 w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-lg font-black text-[#1b4332]">
                                        {index + 1}
                                    </div>
                                </div>
                            </div>
