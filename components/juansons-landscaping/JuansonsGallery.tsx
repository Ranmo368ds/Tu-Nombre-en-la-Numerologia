...
const galleryImages = [
    { src: "/images/juansons/pics/Artboard-10.png", size: "lg" },
    ...
    { src: "/images/juansons/pics/Artboard-30.png", size: "sm" },
    { src: "/images/juansons/pics/Artboard-35.png", size: "sm" },
];
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-[250px]">
                    {galleryImages.map((image, index) => (
                        <motion.div
                            ...
                            className={`relative group overflow-hidden ${image.size === "lg" ? "md:col-span-2 md:row-span-2" :
